  ...
  return (
    <div
      className={cn(
        ...
        '[&_input[type="checkbox"]]:size-5.75 [&_input[type="checkbox"]:not(:disabled):hover]:cursor-pointer [&_input[type="checkbox"]]:appearance-none [&_input[type="checkbox"]]:rounded-[6px] [&_input[type="checkbox"]]:border [&_input[type="checkbox"]]:border-[#CDCDCD]/60 [&_input[type="checkbox"]]:bg-center [&_input[type="checkbox"]]:bg-no-repeat',
    ...
    >
      <div
        className={cn(
          'mx-auto w-full max-w-92.5 rounded-[6px] bg-white py-2.5 shadow-[0px_8px_15px_0px_#1414141F,0px_0px_4px_0px_#1414141A]',
          'flex flex-col',
        )}
      >
