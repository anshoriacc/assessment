  ...
  return (
    <div
      className={cn(
        ...
        '[&_input[type="checkbox"]]:size-5.75 [&_input[type="checkbox"]]:appearance-none [&_input[type="checkbox"]]:rounded-[6px] [&_input[type="checkbox"]]:border [&_input[type="checkbox"]]:border-[#CDCDCD]/60 [&_input[type="checkbox"]]:bg-center [&_input[type="checkbox"]]:bg-no-repeat [&_input[type="checkbox"]:not(:disabled):hover]:cursor-pointer',
